...
import { InsertToSupabase, splitedDocs } from "../lib/insertToSuprabase.cjs";
...
// this should run only once for uploding csv data to supabase then you can continue with the chatbot functionality
